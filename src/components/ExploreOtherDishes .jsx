...
const ExploreOtherDishes = () => {
  ...
  return (
    <div className="p-5 bg-background">
      <h1 className="text-2xl font-bold mb-4 text-center">Explore Other Dishes</h1>
      <p className="text-center mb-4 text-gray-700">Discover a variety of delightful dishes. There's always something new to try!</p>
      <Swiper
      ...
      <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 md:gap-4">
        {items.map((item) => (
          <div key={item.id} className="shadow-md border-2 rounded-md p-1 md:p-2 bg-white">
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="flex items-center justify-between w-full gap-2">
                ...
                <button title="add to cart" className="bg-primary hover:bg-red-700  text-white py-1 px-2 text-xs lg:text-sm rounded-md w-1/2 flex items-center justify-center">
...
export default ExploreOtherDishes;
