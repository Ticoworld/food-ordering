...
const Drinks = () => {
  ...
  return (
    <div className="px-6 py-7 bg-background">
      <h2 className="text-gray-900 text-center font-bold lg:text-2xl text-xl py-7">Drinks</h2>
      <p className="text-center mb-4 text-gray-700">Refresh yourself with our wide selection of beverages. Order your drink now!</p>
